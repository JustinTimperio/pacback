...
def compare(config, target_version):
    ...
    if config['version'] != target_version:
        ...
        # Check for V1.5 to V1.7
            ...
            paf.prError('Restore Points Generated By Alpha Versions of Pacback Must Be Upgraded!')
            paf.write_to_log(fname, 'Detected Alpha Restore Point That Needs to Be Upgraded', config['log'])
